				...
				<div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr]">
					<div>
						...
						<h2 className="max-w-md text-4xl font-black leading-[0.96] tracking-[-0.04em] text-slate-950">
							One real-time view of the{" "}
							<span className="text-blue-600">company.</span>
						</h2>
						<p className="mt-4 max-w-md text-[12px] leading-5 text-slate-500">
							Replace disconnected reports with a live operating picture of
							attendance, people, field activity, payroll and workforce
							performance.
						</p>
					</div>
						...
						<div className="grid gap-3 sm:grid-cols-[1.25fr_.75fr]">
							<GlassCard className="p-4">
								<div className="mb-3 flex items-center justify-between">
									...
									<div className="flex items-center gap-1 text-[7px] text-emerald-500">
										<ArrowUpRight size={9} /> 8.4%
									</div>
								</div>
								<TinyBars />
							</GlassCard>
